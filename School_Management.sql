...
INSERT INTO `students` (`student_id`, `user_id`, `date_of_birth`, `roll_number`) VALUES
(1, 12, NULL, NULL),
(2, 13, NULL, NULL),
(3, 18, NULL, NULL);
...
INSERT INTO `teachers` (`teacher_id`, `user_id`, `department`, `qualification`) VALUES
(1, 11, NULL, NULL),
(2, 14, NULL, NULL),
(3, 15, NULL, NULL),
(4, 16, NULL, NULL),
...
(1, 'adminuser', '$2y$10$HASHEDPASSWORD...', 'admin', 'admin@example.com'),
...
(12, 'st123', '$2y$10$K58Ze/FNjVheyf2nwj/Kpe1ATjmQwLBI30BWAnrG3u4gTqGS4vOk2', 'student', 'st123@gmail.com'),
